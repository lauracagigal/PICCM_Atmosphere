...
Single-file concatenation of all CIndRA assistant markdowns. Generated on 2026-07-28. Source files live in `assistant/` and `assistant/skills/`; regenerate with `python assistant/build_aggregated_CIndRA.py`.
